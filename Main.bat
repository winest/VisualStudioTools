...
for ( ;; )
{
    ...
    WScript.Echo( "What would you like to do?\n" +
                  ...
                  "4. Build all *.sln\n" +
                  "5. Remove garbages generated by Visual Studio when compiling a user mode program\n" +
                  "6. Remove garbages generated by Visual Studio when compiling a kernel mode program\n" +
                  "7. Leave" );
    ...
    switch ( strChoice )
    {
        ...
        case "3" :
        {
            ...
            if ( true == CWUtils.SelectYesNo( "Update *.vcxproj files under \"" + strFolder + "\"? (y/n)" ) )
            {
                TraverseAndRelocateVcProjInclude( strFolder , aryFolderMap , strLogFolder );
            }
            break;
        }
        case "4" :
...
{
    var aryChoices = [ "Debug\\|Win32" , "Debug\\|x64" , "Release\\|Win32" , "Release\\|x64" ];
    var strBuildCfgs;
    for ( ;; )
    {
